...
describe('My application\'s top menu ' , () => {
    ...
    describe('for user with role Admin', () => {
        ...
        expect($('//a[.="JavaScript Practice"]')).toBeExisting();
        });

        it('should detect when element (JavaScript Practice) is visible', () => {
            const elem = $('//a[.="JavaScript Practice"]');
        ...
        //
        //     it(' s', () => {
        //         expect(links[i].getText()).toHaveTextContaining('other_text');
        //     });
        //
        // }
        //
...
//     //     arr.push(arr1[i].innerText);
//     // }
//     expect(arr1[0].innerText).toEqual('Databases');
//
// });